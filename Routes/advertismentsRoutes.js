...
Router.put(
  "/advertisement/book/:id",
  bookAdvertisementController.bookAdvertisement
);
Router.put("/advertisement/cancel", advertisementController.cancelAdvetisement);
Router.put(
  "/advertisement/book/advance/:id",
  bookAdvertisementController.advanceBooking
);

Router.get(
  "/user/bookinghistory/:id",
  advertisementController.getBookingHistory
);
